...
public class DocumentController {
		...
		try {			
			for (int i = 0; i < fileLength; i++) {
				...
				if (file != null) {
					...
					String filePath = FileUtil.saveFile(file, saveFilePath, request);
	...
	public void downloadDocument(@RequestParam("path")String path, HttpServletRequest request, HttpServletResponse response) {
	...
	@ResponseBody
	public String removeDocument(int docId, String path, HttpServletRequest request) {
